describe('serializer', function () {
  ...
  describe('default provider options', function () {
    ...
    beforeEach(inject(function ( Serializer) {
      console.log("test/serializer.js:69", "serializer", serializer);
      serializer = new Serializer();
      console.log("test/serializer.js:71", "serializer", serializer);
    }));
    ...
    describe('default config', function () {
      ...
      it('should underscore attributes on single object', function () {
        ...
        console.log("test/serializer.js:76", "serializer", serializer);
