  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved tagging as @tagging" do
        ...
        post :create, {:tagging => { "tag_id" => "invalid value" }}, valid_session
        assigns(:tagging).should be_a_new(Tagging)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested tagging" do
        ...
        Tagging.any_instance.should_receive(:update).with({ "tag_id" => "1" })
        put :update, {:id => tagging.to_param, :tagging => { "tag_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the tagging as @tagging" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Tagging.any_instance.stub(:save).and_return(false)
        put :update, {:id => tagging.to_param, :tagging => { "tag_id" => "invalid value" }}, valid_session
        assigns(:tagging).should eq(tagging)
      end
