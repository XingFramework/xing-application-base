...
describe DelayedJobsController do
  ...
  let(:valid_attributes) { { "priority" => "1" } }

  # This should return the minimal set of values that should be in the session
  # in order to pass any filters (e.g. authentication) defined in
  # DelayedJobsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved delayed_job as @delayed_job" do
        ...
        post :create, {:delayed_job => { "priority" => "invalid value" }}, valid_session
        assigns(:delayed_job).should be_a_new(DelayedJob)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested delayed_job" do
        ...
        DelayedJob.any_instance.should_receive(:update).with({ "priority" => "1" })
        put :update, {:id => delayed_job.to_param, :delayed_job => { "priority" => "1" }}, valid_session
      end

      it "assigns the requested delayed_job as @delayed_job" do
        delayed_job = DelayedJob.create! valid_attributes
        put :update, {:id => delayed_job.to_param, :delayed_job => valid_attributes}, valid_session
        assigns(:delayed_job).should eq(delayed_job)
      end
    ...
    describe "with invalid params" do
      it "assigns the delayed_job as @delayed_job" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        DelayedJob.any_instance.stub(:save).and_return(false)
        put :update, {:id => delayed_job.to_param, :delayed_job => { "priority" => "invalid value" }}, valid_session
        assigns(:delayed_job).should eq(delayed_job)
      end
