  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved tutorial as @tutorial" do
        ...
        post :create, {:tutorial => { "title" => "invalid value" }}, valid_session
        assigns(:tutorial).should be_a_new(Tutorial)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested tutorial" do
        ...
        Tutorial.any_instance.should_receive(:update).with({ "title" => "MyString" })
        put :update, {:id => tutorial.to_param, :tutorial => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the tutorial as @tutorial" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Tutorial.any_instance.stub(:save).and_return(false)
        put :update, {:id => tutorial.to_param, :tutorial => { "title" => "invalid value" }}, valid_session
        assigns(:tutorial).should eq(tutorial)
      end
