...
describe DelayedJobsController do
  describe "routing" do
    ...
    it "routes to #index" do
      get("/delayed_jobs").should route_to("delayed_jobs#index")
    end
    ...
    it "routes to #show" do
      get("/delayed_jobs/1").should route_to("delayed_jobs#show", :id => "1")
    end
    ...
    it "routes to #destroy" do
      delete("/delayed_jobs/1").should route_to("delayed_jobs#destroy", :id => "1")
    end
